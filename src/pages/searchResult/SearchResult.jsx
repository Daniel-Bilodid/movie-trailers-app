  ...
  return (
    <>
      ...
      <div className="popular">
        <div className="popular__text-wrapper"></div>
        <div className="popular__wrapper">
          {data
            .slice(0, 10)
            .map(
              (
                { movie, trailers, currentTrailerIndex, release_year },
                index
              ) => (
                <div key={movie.id}>
        ...
        <Modal isOpen={playVideo !== null} onClose={handleCloseModal}>
          {playVideo !== null &&
            data.trailers[playVideo] &&
            data.trailers[playVideo].data.trailers && (
              <>
                <iframe
                  ...
                  src={`https://www.youtube.com/embed/${
                    data.trailers[playVideo].data.trailers[
                      data.trailers[playVideo].currentTrailerIndex
                    ].key
                  }`}
                  title={
                    data.trailers[playVideo].data.trailers[
                ...
                <div className="trending__movie-info">
                  <div className="trending__movie-wrapper">
                    <div className="trending__movie-year">
                      {data.trailers[playVideo].release_year}
                    </div>
